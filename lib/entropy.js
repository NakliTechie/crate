...
// zxcvbn's guesses estimate into bits so the onboarding wizard can gate
// Next at a ≥70-bit floor.
//
...
// Strength floors shared by the wizard and the folder's change-passphrase
// dialog: 55 bits recommended (five unrelated words), 20 bits the hard
// refusal line — below that the passphrase is guessable in minutes.
export const MIN_BITS = 55;
export const HARD_MIN_BITS = 20;
