...
export class SyncClient {
  ...
  async _pollManifest() {
    ...
    // folder UI, refresh runner) sees the new state. M6 v1.0 assumed
    // local manifests are flushed after every mutation; M6.x makes that
    // an invariant via ETag-conditional PUT, so we know nothing local
    // is unflushed here either.
