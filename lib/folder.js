...
export class FolderUI {
  ...
  buildBackupView() {
    ...
    return h("div", { class: "view-cards" }, [
      ...
      h("div", { class: "view-card" }, [
        h("div", { class: "view-card-body" }, [
          h("h2", {}, ["Passphrase"]),
          h("p", {}, ["Nobody can reset it — not us, not your storage provider. If it's only in your head, write it down somewhere you'll still find in five years."]),
        ]),
      ]),
    ]);
  }
  ...
  buildTree() {
    const wrap = h("ul", { class: "folder-tree", "aria-label": FolderUI.VIEW_TITLES[this.view] });
