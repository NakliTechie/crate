...
// v3: added `offline` — the last crate.json + manifest bytes seen per
// bucket, as they came off the wire (still sealed). See lib/offline.js.
const DB_VERSION = 3;
const STORES = ["prefs", "onboarding", "anchors", "offline"];
