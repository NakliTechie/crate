...
// Bitcoin seed phrase): the phrase is shown ONCE during onboarding for
// the user to write down. It encodes the same entropy the master key is
// derived from, so a future "Forgot passphrase" flow can use it to set
// a new passphrase against the same bucket. The phrase is NOT a direct
// substitute for the master key — there's no PBKDF2 step you can skip.
//
// Exports:
