      ...
      switch (e.op) {
        case "create":
          byUuid.set(e.uuid, {
            ...
            content_iv: e.content_iv, chunk_size: e.chunk_size, ts: e.ts,
          });
          trash.delete(e.uuid);
          break;
        case "update": {
...
export function createEvent({ uuid, path, size, mime, dataKeyIv, dataKeyCt, contentIv, chunkSize }) {
  const evt = {
    op: "create",
    uuid, path, size,
...
export function updateEvent({ uuid, size, contentIv, chunkSize }) {
