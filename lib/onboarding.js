    ...
    return makeFragment(
      el("section", { class: "stage stage-welcome", "aria-labelledby": "stage-title" }, [
        ...
        el("div", { class: "preview-banner" }, [
          el("strong", {}, ["Preview — M2 of M8."]),
          " The onboarding flow works end-to-end against a real R2 bucket. The folder UI (M4) and encryption layer (M3) land in later milestones — pairing currently ends at a 'folder will appear here' screen with no working file operations yet.",
        ]),
        ...
        el("p", { class: "muted small" }, [
          "Roadmap: M3 encryption + signed manifest · M4 folder UI · M5 ESM API · M6 sync · M7 QR pairing · M8 ship → crate.naklitechie.com.",
        ]),
        el("p", { class: "muted small footer-links" }, [
