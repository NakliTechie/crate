...
function promiseList() {
  ...
  return el("ul", { class: "promise-list" }, [
    ...
    item("🪣", "Your storage, your keys", "Bring your own bucket — Cloudflare R2, Hetzner, Backblaze, or AWS. We never hold your data and there's nothing to subscribe to."),
  ...
  function renderCarrier() {
    ...
    return makeFragment(
      el("section", { class: "stage stage-carrier" }, [
        ...
        el("details", { class: "prereqs-details", open: "" }, [
          el("summary", {}, ["You'll need (both free)"]),
          prerequisitesList(),
        ]),
        el("ol", { class: "steps" }, [
          el("li", {}, [
          ...
          el("li", {}, [
            el("p", {}, ["2 · Deploy — pick your GitHub account, paste the secret, click ", el("b", {}, ["Deploy"]), "."]),
