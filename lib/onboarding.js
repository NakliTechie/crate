  ...
  function openHelpModal() {
    ...
    card.appendChild(step(1, "Get a Cloudflare account (60 seconds, free tier)", [
      el("p", {}, [
        ...
        ". Free tier is enough — R2 includes 10 GB of free storage + 1 million reads + 10 million writes per month. No credit card required for the free tier.",
      ]),
    ]));
    ...
    card.appendChild(step(6, "Pick a passphrase you'll remember", [
      ...
      el("p", {}, [
        el("strong", {}, ["This passphrase IS your data."]),
        " Crate can't reset it. Write it down somewhere safe (the Recovery step on the next page gives you a 24-word backup — same deal: write it down).",
      ]),
    ]));
