  ...
  function renderWelcome() {
    ...
    return makeFragment(
      el("section", { class: "landing", "aria-labelledby": "stage-title" }, [
        ...
        el("div", { class: "landing-meta" }, [
          el("p", { class: "prereqs-title" }, ["Before you start — you'll need:"]),
          prerequisitesList(),
          el("p", { class: "muted small" }, ["About a minute, start to finish. Already have a bucket and an API token? Use ", el("b", {}, ["Set up with your own bucket"]), "."]),
        ]),
