...
export function createWizard({ root, onComplete, liveRegion } = {}) {
  ...
  function renderWelcome() {
    const newFolderBtn = el("button", { type: "button", class: "btn btn-primary btn-block btn-lg" }, ["Set up a new folder"]);
    ...
    return makeFragment(
      el("section", { class: "landing", "aria-labelledby": "stage-title" }, [
        ...
        promiseList(),
        el("div", { class: "landing-actions" }, [newFolderBtn, unlockBtn]),
        el("p", { class: "landing-help" }, [helpLink]),
        el("p", { class: "landing-meta" }, ["You'll need a free Cloudflare account, about 3 minutes, and a passphrase you'll remember."]),
