    ...
    return makeFragment(
      el("section", { class: "stage stage-welcome", "aria-labelledby": "stage-title" }, [
        ...
        el("div", { class: "preview-banner" }, [
          el("strong", {}, ["Preview — M5 of M8."]),
          " Encryption + signed manifest + folder UI are live. Multi-device sync (M6), QR pairing (M7), and DNS to ",
          el("code", {}, ["crate.naklitechie.com"]),
          " (M8) land next.",
        ]),
        el("p", { class: "muted" }, ["You'll need: a Cloudflare account (free tier works), about 3 minutes, and a passphrase you'll remember."]),
        el("div", { class: "stage-actions" }, [newFolderBtn, unlockBtn, pairBtn]),
